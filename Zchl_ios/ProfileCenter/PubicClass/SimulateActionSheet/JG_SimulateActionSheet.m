...
@interface JG_SimulateActionSheet()<UIPickerViewDelegate>
{
...
@implementation JG_SimulateActionSheet
+(instancetype)styleDefault{
    JG_SimulateActionSheet* sheet = [[JG_SimulateActionSheet alloc]initWithFrame:CGRectMake(
                                                                                      0,
                                                                                      0,
...
-(UIPickerView *)actionPicker;{
    UIPickerView *picker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 44,SCREEN_WIDTH,200)];
...
-(void)setDelegate:(id<SimulateActionSheetDelegate>)delegate{
    _delegate = delegate;
    _pickerView.delegate =(id<UIPickerViewDelegate> ) delegate;
}
@end