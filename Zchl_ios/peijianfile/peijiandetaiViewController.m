...
#import "LSFfirstCell.h"
#import "secondCell.h"
#import "threeCell.h"

@interface peijiandetaiViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation peijiandetaiViewController
...
- (void)viewDidLoad {
    ...
    _leftArr = @[@"品牌",@"生产地",@"型号"];
    _rightArr = @[@"柳工",@"广西",@"1W321F"];
    
    [self setNav];
    [self.detaitableView tableViewGetFootEmptyView];
...
-(void)setNav{
    ...
    UIColor * colorOne = Color_RGBA(1, 246, 226, 1.0);
    UIColor * colorTwo = Color_RGBA(62, 144, 234, 1.0);
...
//        LSFfirstCell * cell = [tableView dequeueReusableCellWithIdentifier:iden];
//        if (cell == nil) {
//            cell = [[LSFfirstCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:iden];
//        }
...
//        float pricr = [_dic[@"price"] floatValue]
